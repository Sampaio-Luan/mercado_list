...
class ItemListaPesquisa<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final corFundoSelecionado =
        estilo.corItemSelecionado ?? temaAtual.colorScheme.primaryContainer.withValues(alpha: 0.4);
  ...
  Widget _construirIndicadorSelecao(ThemeData temaAtual) {
    final corIndicador = estilo.corIconeSelecionado ?? temaAtual.colorScheme.primary;
