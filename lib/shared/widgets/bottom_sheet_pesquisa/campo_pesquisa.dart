    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          filled: true,
          fillColor: estilo.corFundoCampoPesquisa ??
              temaAtual.colorScheme.surfaceContainerHighest,
          contentPadding: const EdgeInsets.symmetric(vertical: 14),
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(estilo.raioBordaCampoPesquisa),
            borderSide: BorderSide(
              color: estilo.corBordaCampoPesquisa ?? Colors.transparent,
            ),
          ),
