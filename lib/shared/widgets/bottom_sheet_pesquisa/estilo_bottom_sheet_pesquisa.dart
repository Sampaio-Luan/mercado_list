...
class EstiloBottomSheetPesquisa {
  const EstiloBottomSheetPesquisa({
    ...
    this.iconePesquisa = Icons.search_rounded,
    this.iconeLimparPesquisa = Icons.close_rounded,
    this.iconeFechar = Icons.close_rounded,
    this.iconeExpandir = Icons.open_in_full_rounded,
    this.iconeRecolher = Icons.close_fullscreen_rounded,
    this.iconeItemSelecionadoUnico = Icons.check_circle_rounded,
    this.iconeItemNaoSelecionadoUnico = Icons.circle_outlined,
    this.elevacao = 8.0,
  });
